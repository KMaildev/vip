 ...
 * @category  Controller
 */
class BlogsController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->search)){
			...
			$search_condition = "(
				blogs.id LIKE ? OR 
				blogs.title LIKE ? OR 
				blogs.description LIKE ? OR 
				blogs.media LIKE ? OR 
				blogs.upload_date LIKE ? OR 
				blogs.created_at LIKE ? OR 
				blogs.updated_at LIKE ?
			)";
			$search_params = array(
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("title","description","media","upload_date");
			...
			$this->sanitize_array = array(
				...
				'media' => 'sanitize_string',
				'upload_date' => 'sanitize_string',
			);
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("id","title","description","media","upload_date");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'title' => 'required',
